...
use hipanel\modules\hosting\grid\AddressGridView;
...
$this->title = Yii::t('hipanel.hosting.ipam', 'IP Addresses');
...
<?php Pjax::begin(array_merge(Yii::$app->params['pjax'], ['enablePushState' => true])) ?>
    <?php $page = IndexPage::begin(compact('model', 'dataProvider')) ?>
        ...
        <?php $page->beginContent('main-actions') ?>
            <?= Html::a(Yii::t('hipanel.hosting.ipam', 'Add a new address'), 'create', ['class' => 'btn btn-sm btn-success']) ?>
        <?php $page->endContent() ?>
